...
![Kubernetes Cluster Initialization](images/1.kubeadm-init-cluster.jpg)

![Kubernetes Cluster Initialization](<img src="images/1.kubeadm-init-cluster.jpg" alt="Kubernetes Cluster Initialization" width="600"/>
)
